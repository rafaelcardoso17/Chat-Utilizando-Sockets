...
import chat.ChatMessage.Action;
...
public class ClienteFrame extends javax.swing.JFrame {
    ...
    private void connected(ChatMessage message) {
        ...
        JOptionPane.showMessageDialog(this, "Você está conectado no chat!Desfrute bem do nosso chat "+message.getName()+" ");
    ...
    private void disconnected() {
        ...
        JOptionPane.showMessageDialog(this, "Você saiu do chat!Até mais "+message.getName()+" ");
    }
    ...
    private void receive(ChatMessage message) {
        ...
        this.txtAreaReceive.append(formatador.format(message.getData()).toString()+" " +message.getName() + " diz: " + message.getText() + "\n");
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Usuários Onlines"));
